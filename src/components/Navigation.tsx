...
const Navigation = () => {
  ...
  const projectsDropdownItems = [
    ...
    { label: "Bisto Proyekto", url: "https://bisto.ph" },
    {
      ...
      url: "https://bettergov.ph/flood-control-projects",
    },
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        procurementDropdownRef.current &&
        !procurementDropdownRef.current.contains(event.target as Node)
      ) {
        setProcurementDropdownOpen(false);
      }
      if (
        taxDropdownRef.current &&
        !taxDropdownRef.current.contains(event.target as Node)
      ) {
  ...
  return (
    <nav className="bg-white shadow-sm">
        ...
        <div className="flex items-center justify-between h-16 md:h-24">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <Link
                to="/"
                className={`flex items-center gap-2 md:px-3 lg:px-4 py-2 md:text-sm lg:text-md transition-colors ${
                  isActive("/")
              ...
              <div className="relative" ref={procurementDropdownRef}>
                ...
                >
                  ...
                  Procurement
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${procurementDropdownOpen ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div className="relative" ref={taxDropdownRef}>
                ...
                >
                  ...
                  Tax Collection
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${taxDropdownOpen ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div className="relative" ref={budgetDropdownRef}>
                ...
                >
                  ...
                  Budget
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${budgetDropdownOpen ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div className="relative" ref={projectsDropdownRef}>
                ...
                >
                  ...
                  Our Projects
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${projectsDropdownOpen ? "rotate-180" : ""}`}
                  />
                </button>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-gray-200 py-2 fixed top-16 left-0 w-full bg-white z-50 h-[calc(100vh-4rem)] overflow-y-auto">
          {/* Home */}
          <Link
            to="/"
            ...
            {procurementItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  to={item.path}
                  onClick={() => setMobileMenuOpen(false)}
                  className={`flex items-center gap-3 px-4 py-3 pl-10 text-sm transition-colors ${
                    active
                      ? "bg-blue-50 text-blue-600 font-semibold border-l-4 border-blue-600"
                      : "text-gray-700 hover:bg-gray-50"
                  }`}
          ...
          <div className="border-t border-gray-200 mt-2 pt-2 z-50 mb-1">
            <div className="z-50 px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider flex items-center gap-2">
              <Briefcase className="h-4 w-4" />
              Our Projects
            </div>
            {projectsDropdownItems.map((item) => (
